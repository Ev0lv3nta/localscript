...
Проект начался как личный прототип для задачи MWS Octapi на MTS True Tech Hack 2026. Автор — Николай Никитенко; соавторов нет, команда не заняла призовое место. Репозиторий не является официальным продуктом или проектом МТС/MWS.
