...
Integrity check ищет точные, нормализованные и нечёткие пересечения слепого набора с живым корпусом. Release gate фиксирует SHA коммита, хеш корпуса, версии Python/Lua/Ollama, digest модели, GPU, метрики стадий, стабильность трёх сценариев в двух прогонах и укладывается в 15 минут. Порог слепого набора — не менее 7 из 8 при нуле невалидных успехов и всех пройденных кейсах безопасности.
