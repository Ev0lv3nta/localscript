...
FALLBACK_MODEL="${LOCALSCRIPT_FALLBACK_MODEL:-${PRIMARY_MODEL}}"
...
SUPPORTED_PYTHON_MIN_MINOR="${LOCALSCRIPT_PYTHON_MIN_MINOR:-10}"
SUPPORTED_PYTHON_MAX_MINOR="${LOCALSCRIPT_PYTHON_MAX_MINOR:-11}"
