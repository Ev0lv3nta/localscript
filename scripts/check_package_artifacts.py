...
WHEEL_REQUIRED = {
    ...
    "app/resources/datasets/adversarial_eval.jsonl",
    "app/resources/datasets/ambiguity_eval.jsonl",
    "app/resources/datasets/clarification_eval.jsonl",
    "app/resources/datasets/composition_eval.jsonl",
    "app/resources/datasets/large_context_eval.jsonl",
    "app/resources/datasets/model_backed_eval.jsonl",
    "app/resources/datasets/multilingual_eval.jsonl",
    "app/resources/datasets/public_gold.jsonl",
    "app/resources/datasets/regression_eval.jsonl",
    "app/resources/datasets/showcase_eval.jsonl",
    "app/resources/datasets/stress_eval.jsonl",
